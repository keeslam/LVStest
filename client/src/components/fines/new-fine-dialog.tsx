...
/** Staff enter a fine; after saving the FineDialog opens with the attribution result. */
      ...
      <DialogContent className="max-w-lg">
        ...
        <form onSubmit={submit} className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div><Label htmlFor="nf-at">{t("admin.fines.fields.offenceAt")}</Label><Input id="nf-at" type="datetime-local" value={form.offenceAt} onChange={set("offenceAt")} required data-testid="input-fine-offence-at" /></div>
            ...
            <div><Label htmlFor="nf-amount">{t("admin.fines.fields.amount")}</Label><Input id="nf-amount" type="number" step="0.01" min="0" value={form.amount} onChange={set("amount")} required data-testid="input-fine-amount" /></div>
