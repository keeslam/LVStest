...
/** Small "Bekeuringen: n" link in the vehicle dialog header, opening the fines list dialog filtered on this plate. */
export function VehicleFinesLink({ licensePlate }: { licensePlate: string | null | undefined }) {
  ...
  return (
    <button type="button" onClick={() => openPortalListDialog("fines", { plate: licensePlate })} className="text-sm underline text-muted-foreground" data-testid="link-vehicle-fines">
